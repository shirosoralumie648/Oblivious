...
| Billing And Monetization Gate | Plans, quota, subscriptions, top-ups, refunds, invoices, Stripe checkout/webhooks, Marketplace settlement, platform fees, and payout state are implemented and auditable. | In progress. Phase 17 completes mounted Stripe checkout/webhook route authority, raw-body webhook signature verification, tenant-aware checkout metadata, `payment_intents`, and idempotent `stripe_webhook_events`. Subscription lifecycle, top-up fulfillment, invoices, refunds, Marketplace settlement, platform fees, payouts, admin billing UI, and v06 closeout remain required. | v06 |
...
- v06 may not claim Billing And Monetization Gate completion until subscription lifecycle, top-up fulfillment, refunds, invoices, failed-payment states, plan changes, Marketplace settlement, payout state, moderation workflows, admin billing inspection, and v06 closeout evidence all pass.
...
The v06 evidence chain is open:
...
- Phase 18 remains required for subscription lifecycle, invoice, top-up, failed-payment, plan-change, and refund state transitions.
- Phase 19 remains required for Marketplace settlement, platform fee, payout state, refund impact, moderation, and abuse workflows.
