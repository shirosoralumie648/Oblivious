...
- Branch: `main`; this rescan covers implementation evidence through the Scheduled Tasks browser proof at `d9495a8 test(workflow): prove scheduled tasks browser journey` plus the current Marketplace recommendation metadata contract/browser proof slice.
