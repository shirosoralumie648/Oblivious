...
- [x] 31.2-02-PLAN.md - Make Go runtime registrations the same source for dispatch/descriptors and compare them to OpenAPI.
- [x] 31.2-04-PLAN.md - Define shared operation-aware HttpClient/stream/upload/SWR contracts and migrate Chat/transport owners.
- [x] 31.2-08-PLAN.md - Run one fresh migration session deriving apply/no-op from ledger snapshots and emitting three reports once.
...
- [x] 31.2-12-PLAN.md - Migrate the fixed eight-file Group B production caller owner set to exact generated operation symbols.
- [x] 31.2-13-PLAN.md - Migrate the first eight Go route helper owners to same-source runtime registration.

**Wave 4** *(blocked on both caller migration groups and Group A route migration)*

- [x] 31.2-10-PLAN.md - Wire authenticated projection API/state/provider into router/nav/marketing and Chat/Agents selectors.
- [x] 31.2-14-PLAN.md - Migrate the remaining eight Go route helper owners and prove Group B dispatch/media parity.

**Wave 5** *(blocked on the route groups and caller foundations)*

- [x] 31.2-15-PLAN.md - Complete the HTTP runtime producer and migrate the two public marketing auth callers.

**Wave 6** *(blocked on complete caller and route ownership closure)*

- [x] 31.2-03-PLAN.md - Build the one-Program production sidecar, enforce exact 25-owner closure, and register frontend reports.

**Wave 7** *(blocked on the full sidecar plus exposure/runtime/protobuf foundations)*

- [x] 31.2-05-PLAN.md - Exact-join one sidecar across transport/exposure and emit two reports over Plan 10 wiring.

**Wave 8** *(blocked on all surface producers)*

- [x] 31.2-09-PLAN.md - Aggregate exact ten reports with one immutable image build, one migration session, sole quality parent and redaction.
...
| 31.2 契约表面一致性与聚合门禁 | 20/23 | In Progress|  |
