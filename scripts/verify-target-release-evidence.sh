...
require_string(failures, data, ["deployment", "evidenceRef"])
...
require_string(failures, data, ["kubernetes", "evidenceRef"])
...
require_string(failures, data, ["secretAudit", "evidenceRef"])
...
require_string(failures, data, ["workflowTelemetry", "evidenceRef"])
