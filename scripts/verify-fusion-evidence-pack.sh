...
require_contains "$pack_file" "required evidence fields"
require_contains "$pack_file" "requestLogObservability"
require_contains "$pack_file" "ragIndexing"
require_contains "$pack_file" "relayRealtime"
require_contains "$pack_file" "relayBatch"
require_contains "$pack_file" "marketplacePayouts"
require_contains "$pack_file" "providerRuntimeConfig"
require_contains "$pack_file" "microserviceDatabases"
require_contains "$pack_file" "request-log-observability"
require_contains "$pack_file" "rag-indexing-proof"
require_contains "$pack_file" "relay-realtime-proof"
require_contains "$pack_file" "relay-batch-proof"
require_contains "$pack_file" "marketplace-payout-proof"
require_contains "$pack_file" "provider-runtime-config"
require_contains "$pack_file" "microservice-database-proof"
require_contains "$pack_file" 'Free-form notes or unrelated `evidenceRef` keys do not count as artifact usage'
require_contains "$pack_file" "secret-like query"
require_contains "$pack_file" "URI userinfo"
require_contains "$pack_file" "credential-bearing environment base URLs"
...
require_contains "$pack_file" "OBLIVIOUS_TARGET_EVIDENCE_ALLOW_COMMIT_MISMATCH"
