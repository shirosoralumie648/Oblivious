...
run_marketplace_money_movement_profile() {
  ...
  admin_money_movement_pattern="^(TestAdminBilling(SummaryIncludesMoneyMovementState|ListsExposeAllRequiredSurfaces|ListsApplyRecoveryFilters|ListHandlersPassBillingFiltersWithoutDatabase|SummaryAppliesFailedStatusFilter|MarksMarketplacePayoutPaid|MarkPayoutPaidHandlerRejectsMissingProviderPayoutID|MarksMarketplacePayoutFailedAndReleasesSettlements|MarkPayoutFailedHandlerRejectsMissingOperatorEvidence|CreateDueMarketplacePayoutsDispatchesConfiguredProvider|RecordsTopupRefundAndAdjustsQuota|RecordTopupRefundHandlerPassesDomesticPaymentIntentEvidence|RecordTopupRefundHandlerRejectsMissingOperatorEvidence|RejectsTopupRefundWithoutOperatorEvidenceAndPreservesLedger|WebhookEventsDoNotExposeRawPayload)|TestMarketplaceAgentDetailExposesConfiguredDomesticPaymentProviders|TestMarketplacePaidInstallDoesNotInstallBeforeWebhook|TestMarketplacePaidInstallCheckoutCreatorFailureMarksOrderFailed|TestMarketplacePaidInstallUsesConfiguredProviderCheckoutCreator|TestMarketplacePaidInstallCheckoutUsesSelectedProviderAndReturnsCheckoutSession|TestMarketplacePaidInstallCheckoutRejectsMissingProviderBeforeSettlement|TestMarketplacePaidInstallCheckoutRejectsConfiguredProviderWithoutCheckoutCreatorBeforeSettlement|TestMarketplacePaidInstallCheckoutRejectsUnsupportedProviderBeforeSettlement|TestMarketplacePublisherStatsIncludesSettlementAmounts|TestBuildPaymentCheckoutProvidersEnablesDomesticHostedProviders|TestStripeWebhookRouteAppliesMarketplaceInstallSettlementOnce|TestStripeRefundUpdatesMarketplaceSettlementOnce|TestDomesticPaymentWebhookHandlerAppliesPayoutLifecycleOnce|TestDomesticPaymentWebhookRouteAppliesMarketplace(InstallSettlementOnce|RefundOnce|PayoutPaidOnce|PayoutFailedOnce))$"
