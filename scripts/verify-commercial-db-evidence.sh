...
run_marketplace_governance_review_profile() {
  ...
  marketplace_governance_pattern="^(TestGovernanceTakedownPreventsNewInstallsAndPreservesHistory|TestGovernanceAppealAndReinstateRecordEvents|TestGovernanceAbuseReportLifecycle|TestGovernanceListsOpenAbuseReportsForReviewQueue|TestGovernanceAbuseReportNotifiesPublisher|TestGovernanceRequestsPublisherChangesForPendingReview|TestAutomatedReviewAllowsCleanAgentToWaitForManualReview|TestAutomatedReviewRejectsPromptInjectionAndSensitiveAPIFindings)$"
  marketplace_http_pattern="^(TestAdminReviewSLAEnforceRouteScansPendingReviewsAndAlerts|TestMarketplaceGovernanceTakedownAppealAndReinstate|TestMarketplaceAbuseReportLifecycle|TestMarketplaceAdminReviewAuditCarriesAgentOrganization|TestMarketplaceAdminReviewNeedsChangesRoute|TestMarketplacePublishRunsAutomatedReviewGovernance|TestAdminMarketplaceListsOpenAbuseReports)$"
