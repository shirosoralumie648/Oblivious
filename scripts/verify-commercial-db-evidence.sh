...
run_marketplace_money_movement_profile() {
  ...
  admin_billing_sql_shape_pattern="^(TestTopupSummaryQueryUsesPaymentIntentProviderFilter|TestMarketplaceSettlementQueriesUsePaymentIntentProviderFilter|TestRecordTopupRefundUpdatesOrderStatusAndRefundedAmount|TestRecordTopupRefundRejectsConflictingProviderRefundEvidence)$"
  marketplace_settlement_pattern="^(TestMarketplaceLifecycleTransitionKeyUsesSelectedProvider|TestMarketplaceRevenueTierDisclosureUsesSegmentedFees|TestPaymentIntentKindMigrationAllowsMarketplaceInstall|TestSettlementCreatePaidInstallCheckoutCreatesPendingOrderAndIntent|TestSettlementCreatePaidInstallCheckoutRecordsSelectedProvider|TestSettlementCreatePaidInstallCheckoutSQLUsesRequestedCurrency|TestSettlementMarkPaidInstallCheckoutFailedMarksOrderAndIntent|TestSettlementAppliesSegmentedPlatformFees|TestSettlementAppliesSpecSegmentedRevenueTiers|TestSettlementMinimumSettlementBlocksSmallPayoutUntilCycleElapsed|TestSettlementApplyPaidInstallCheckoutCompletedRecordsSelectedProviderLifecycle|TestSettlementApplyPaidInstallCheckoutCompletedCreatesInstallAndSettlementOnce|TestSettlementApplyRefundAdjustsOrderAndSettlementOnce|TestSettlementBuyerUninstallPreservesPaidOrderAndSettlement|TestSettlementPublisherDeleteWithPaidOrderIsRejectedAndPreservesAudit|TestSettlementAuditRetentionMigrationRejectsDirectAuditCascade|TestSettlementPayoutRequiresConfiguredProvider|TestSettlementCreateDuePayoutsRequiresConfiguredProvider|TestSettlementMarkPayoutPendingDispatchesConfiguredProvider|TestSettlementMarkPayoutPaidUpdatesPayoutAndSettlementsOnce|TestSettlementProviderPayoutPaidWebhookMatchesProviderPayoutIDOnce|TestSettlementProviderPayoutFailedWebhookReleasesSettlementsOnce|TestSettlementMarkPayoutFailedReleasesSettlementsOnce|TestSettlementCreateDuePayoutsAggregatesAvailableSettlementsOnce|TestSettlementCreateDuePayoutsDispatchesConfiguredProvider|TestSettlementPublisherStatsIncludesSettlementAmounts)$"
  admin_money_movement_pattern="^(TestAdminBillingSummaryIncludesMoneyMovementState|TestAdminBillingListsExposeAllRequiredSurfaces|TestAdminBillingListsApplyRecoveryFilters|TestAdminBillingListHandlersPassBillingFiltersWithoutDatabase|TestAdminBillingSummaryAppliesFailedStatusFilter|TestAdminBillingMarksMarketplacePayoutPaid|TestAdminBillingMarkPayoutPaidHandlerRejectsMissingProviderPayoutID|TestAdminBillingMarksMarketplacePayoutFailedAndReleasesSettlements|TestAdminBillingMarkPayoutFailedHandlerRejectsMissingOperatorEvidence|TestAdminBillingCreateDueMarketplacePayoutsDispatchesConfiguredProvider|TestAdminBillingRecordsTopupRefundAndAdjustsQuota|TestAdminBillingRecordTopupRefundHandlerPassesDomesticPaymentIntentEvidence|TestAdminBillingRecordTopupRefundHandlerRejectsMissingOperatorEvidence|TestAdminBillingRejectsTopupRefundWithoutOperatorEvidenceAndPreservesLedger|TestAdminBillingWebhookEventsDoNotExposeRawPayload|TestMarketplaceAgentDetailExposesConfiguredDomesticPaymentProviders|TestMarketplacePaidInstallDoesNotInstallBeforeWebhook|TestMarketplacePaidInstallCheckoutCreatorFailureMarksOrderFailed|TestMarketplacePaidInstallUsesConfiguredProviderCheckoutCreator|TestMarketplacePaidInstallCheckoutUsesSelectedProviderAndReturnsCheckoutSession|TestMarketplacePaidInstallCheckoutRejectsMissingProviderBeforeSettlement|TestMarketplacePaidInstallCheckoutRejectsConfiguredProviderWithoutCheckoutCreatorBeforeSettlement|TestMarketplacePaidInstallCheckoutRejectsUnsupportedProviderBeforeSettlement|TestMarketplacePublisherStatsIncludesSettlementAmounts|TestBuildPaymentCheckoutProvidersEnablesDomesticHostedProviders|TestStripeWebhookRouteAppliesMarketplaceInstallSettlementOnce|TestStripeRefundUpdatesMarketplaceSettlementOnce|TestDomesticPaymentWebhookHandlerAppliesPayoutLifecycleOnce|TestDomesticPaymentWebhookRouteAppliesMarketplaceInstallSettlementOnce|TestDomesticPaymentWebhookRouteAppliesMarketplaceRefundOnce|TestDomesticPaymentWebhookRouteAppliesMarketplacePayoutPaidOnce|TestDomesticPaymentWebhookRouteAppliesMarketplacePayoutFailedOnce)$"
...
run_marketplace_governance_review_profile() {
  ...
  local marketplace_sla_pattern
  local marketplace_http_pattern

  marketplace_governance_pattern="^(TestGovernanceMigrationAllowsRuntimeReviewActions|TestGovernanceTakedownPreventsNewInstallsAndPreservesHistory|TestGovernanceAppealSQLMovesTakedownIntoPendingAppealQueue|TestGovernanceAppealMovesTakedownIntoPendingAppealQueue|TestGovernanceReinstateSQLRequiresPendingAppealDecision|TestGovernanceReinstateRejectsTakedownWithoutAppeal|TestGovernanceReinstateAfterPendingAppealRecordEvents|TestGovernanceRejectAppealSQLRequiresPendingAppealDecision|TestGovernanceRejectAppealRejectsTakedownWithoutPendingAppeal|TestGovernanceAssignReviewSQLRecordsReviewerAssignment|TestGovernanceAssignReviewRejectsApprovedAgent|TestGovernanceAssignReviewRejectsClaimByAnotherReviewer|TestGovernanceAssignReviewAllowsSameReviewerToRefreshClaim|TestGovernanceAbuseReportLifecycle|TestGovernanceListsOpenAbuseReportsForReviewQueue|TestGovernanceAbuseReportNotifiesPublisher|TestGovernanceRequestsPublisherChangesForPendingReview|TestAutomatedReviewAllowsCleanAgentToWaitForManualReview|TestAutomatedReviewRejectsPromptInjectionAndSensitiveAPIFindings)$"
  marketplace_sla_pattern="^(TestServiceEnforceReviewSLAsAlertsDueSoonAndOverdueOnce|TestServiceEnforceReviewSLAsIncludesAppealPendingQueue)$"
  marketplace_http_pattern="^(TestAdminHandlerListsReviewsWithMarketplaceReviewSLA|TestAdminHandlerListsAssignedMarketplaceReviewReviewer|TestAdminHandlerListsAppealPendingMarketplaceReviews|TestAdminHandlerClaimsMarketplaceReview|TestAdminHandlerEnforcesMarketplaceReviewSLA|TestAdminReviewSLAEnforceRouteScansPendingReviewsAndAlerts|TestMarketplaceGovernanceTakedownAppealAndReinstate|TestMarketplaceGovernanceRejectsPendingAppeal|TestMarketplaceAbuseReportLifecycle|TestMarketplaceAdminReviewAuditCarriesAgentOrganization|TestMarketplaceAdminReviewNeedsChangesRoute|TestMarketplacePublishRunsAutomatedReviewGovernance|TestAdminMarketplaceListsOpenAbuseReports|TestRouteSurfaceAdminMarketplaceReviewMutationsRejectAdminCookieWithoutCSRFWithoutDatabase)$"
  ...
  run_go_test_no_skips "marketplace review SLA enforcement persistence" "./internal/marketplace" "$marketplace_sla_pattern"
...
run_marketplace_recommendation_search_profile() {
  ...
  marketplace_recommendation_pattern="^(TestSearchAgentsRecommendedRanksContentMatchesOverGenericHotAgents|TestSearchAgentsRecommendedFallbackExplorationIsDeterministicAndNonEmpty|TestSearchAgentsRecommendedUsesRankingSignals|TestSearchAgentsRecommendedUsesCollaborativeFilteringForRequester|TestSearchAgentsRecommendedDemotesGovernanceWeightedAgents)$"
...
run_billing_checkout_topup_http_profile() {
  ...
  billing_checkout_topup_pattern="^(TestConsoleBillingPaymentProvidersExposeConfiguredCheckoutProviders|TestHostedCheckoutCreatorRejectsSecretBearingBaseURLs|TestBillingCheckoutRequiresSession|TestBillingCheckoutPersistsTenantPaymentIntent|TestBillingCheckoutExplicitStripeUsesExistingCheckout|TestBillingCheckoutUnconfiguredProvidersDoNotCreateArtifacts|TestBillingCheckoutCreatorFailureMarksTopupFailed|TestBillingCheckoutUsesConfiguredProviderCheckoutCreator|TestBillingCheckoutUsesConfiguredDomesticProviderFromRouterConfig|TestBillingCheckoutTopupDoesNotCreditQuotaBeforeWebhook|TestQuotaTopupEndpointNoLongerCreditsWithoutPayment|TestDomesticPaymentWebhookRoutesVerifySignatureAndRecordEvents|TestDomesticPaymentWebhookRouteAppliesTopupLifecycleOnce|TestDomesticPaymentWebhookRouteAppliesTopupRefundOnce|TestDomesticPaymentWebhookRouteAppliesSubscriptionLifecycleOnce|TestStripeWebhookRouteRejectsInvalidSignature|TestStripeWebhookRouteRecordsSignedEventOnce|TestStripeWebhookRouteAppliesCheckoutCompletedSubscriptionOnce|TestStripeWebhookRouteRetriesLifecycleForRecordedDuplicateEvent)$"
...
run_app_stateful_routes_profile() {
  ...
  app_stateful_routes_pattern="^(TestConsoleAPITokenCreateListAndRevoke|TestConsoleUsageReflectsRecordedChatRequests|TestConsoleUsageListsCurrentUserRecentRelayRequests|TestSelectOrganizationRequiresMembershipAndUpdatesSessionScope|TestOrganizationInvitationRevokeRejectsAcceptance|TestOrganizationSessionSecurityOnMembershipChanges|TestNotificationMutationRoutesEnforceOwnership|TestGetPreferencesReturnsUserInitializationState|TestUpdatePreferencesPersistsOnboardingState|TestConversationAndMessageFlow|TestConversationConfigFlow|TestTaskApproveRouteRequiresAwaitingConfirmationAndWorkspaceScope|TestRouteSurfaceRequiresSessionForAppRoutes|TestRouteSurfaceRejectsCookieMutationWithoutCSRF)$"
...
run_tenant_membership_lifecycle_profile() {
  ...
  tenant_store_pattern="^(TestSQLStoreOrganizationLifecycle|TestSQLStoreMembershipInvitationOwnershipLifecycle)$"
  tenant_http_pattern="^(TestRegisterCreatesDefaultOrganizationAndSessionScope|TestLoginResolvesDefaultOrganizationForLegacyUser|TestSelectOrganizationRequiresMembershipAndUpdatesSessionScope|TestOrganizationInvitationRevokeRejectsAcceptance|TestOrganizationSessionSecurityOnMembershipChanges|TestOrganizationMemberRoutesListTransferOwnershipAndRemove|TestAdminOrganizationRoutesPersistWithPostgres)$"
...
run_tenant_cross_surface_profile() {
  ...
  tenant_cross_surface_pattern="^(TestCrossTenantChatScopeUsesActiveOrganization|TestCrossTenantKnowledgeScopeDeniesReadWriteAndAttach|TestCrossTenantConsoleUsageUsesActiveOrganization|TestCrossTenantAgentScopeDeniesReadWriteAndConversation|TestCrossTenantMemoryScopeDeniesReadWrite|TestCrossTenantMCPScopeDeniesReadWriteAndConnect|TestCrossTenantQuotaScopeUsesActiveOrganization|TestCrossTenantScheduledTaskScope|TestCrossTenantMarketplacePublisherScopeUsesActiveOrganization|TestMarketplacePublisherSettlementPreferencesUseActiveOrganization|TestAgentRunStatusEndpointsExposeTenantScopedRunDetail|TestAgentToolRunApprovalRejectRetryEndpointsAreTenantScoped)$"
...
run_agent_runtime_memory_profile() {
  ...
  agent_runtime_memory_pattern="^(TestAgentRunStorePersistsRunLifecycle|TestAgentToolRunStorePersistsToolLifecycle|TestAgentToolRunStorePersistsRiskLevel|TestAgentPlanStepStoreRoundTripsStepsInOrder|TestAgentPlanStepStoreUpdatesStatusAndExecutionResult|TestAgentSQLStorePersistsApprovalConfigAndToolRiskLevels|TestAgentSQLStorePersistsDefaultExecutionModeConfig|TestAgentSQLStorePersistsLongTermMemoryWritePolicyConfig|TestAgentMemoryStorePersistsAndFiltersMemories)$"
  ...
  agent_tool_runtime_pattern="^(TestCallAgentToolRegistration|TestCallAgentToolRegistration_RecursionLimit|TestCallAgentTool_RecursionDepthGuard|TestWebsearchTool_PrimarySuccess|TestWebsearchTool_FallbackChain|TestWebsearchTool_AllProvidersExhausted|TestWebsearchTool_MissingProviderInMap|TestWebsearchTool_EmptyFallback|TestWebsearchTool_NoProviders|TestWebsearchTool_IntegrationWithConfig|TestWebsearchTool_IntegrationWithMockProviders|TestWebsearchTool_DefaultProvider|TestWebsearchTool_MultipleProvidersChain)$"
...
run_scheduled_task_runtime_profile() {
  ...
  scheduled_task_store_pattern="^(TestSQLStoreCreatesAndListsScheduledTasksByOrganization|TestSQLStoreSyncsWorkflowTriggerBackedScheduledTasksWithoutTouchingManualTasks|TestSQLStoreGetsAndUpdatesScheduledTaskEnabledState|TestSQLStoreRecordsAndListsScheduledTaskRunsByOrganizationAndTask|TestSQLStoreClaimsDueScheduledTaskRunsOnceAndRecordsRunningRuns|TestSQLStoreCompletesManualScheduledTaskRunWithoutAdvancingNextRun|TestSQLStoreCompletesScheduledTaskRunAndAdvancesTask|TestSQLStoreFailsScheduledTaskRunAndAdvancesTaskToAvoidImmediateReclaim)$"
  scheduled_task_routes_pattern="^(TestScheduledTasksRouteCreatesAndListsTasks|TestScheduledTasksRouteListsRunsForTaskWithinSessionOrganization|TestDefaultRouterSyncsWorkflowScheduleTriggersToScheduledTasks)$"
...
run_relay_runtime_channel_isolation_profile() {
  ...
  local relay_batch_lifecycle_pattern

  relay_runtime_pattern="^(TestLoadBalancerSelectModelForOrganizationFiltersModelRouteAndFallback|TestRouterRouteWithBillingUsesTrustedOrganizationForChannelSelectionAndAffinity|TestRelayStoreConversationAffinityPersistsAndUpdatesChannel|TestRelayStoreLoadPoolPreservesChannelOrganizationScope|TestRelayStoreProtectsChannelAPIKeyAtRestAndHydratesRuntimeKey|TestRelayStoreRegisterBatchPollingPersistsDurableTask)$"
  relay_batch_lifecycle_pattern="^(TestBatchUsageFinalizerRecordsFailureUsageAuditBeforeRefund|TestBatchUsageFinalizerSettlesDurableQuotaContext|TestBatchPollingWorkerRefundsTerminalFailureBeforeDeadLetter|TestNewRelayProductionBatchCommercialLifecycleRequiresPollingRegistrar)$"
  run_go_test_no_skips "relay runtime channel active-organization isolation" "./internal/relay" "$relay_runtime_pattern"
  run_go_test_no_skips "relay batch commercial lifecycle audit" "./internal/relay" "$relay_batch_lifecycle_pattern"
  run_go_test_no_skips "relay realtime production pricing lifecycle gate" "./internal/relay" "^(TestNewRelayProductionRealtimeCommercialLifecycleRequiresRealtimePricing|TestNewRelayProductionRealtimeCommercialLifecycleAcceptsActiveRealtimePricing)$"
  run_go_test_no_skips "relay realtime streaming abort settlement and request-log linkage" "./internal/relay" "^TestRouterRouteWithBillingFinalizesStreamingAbortUsageAndRequestLogScope$"
  run_go_test_no_skips "relay realtime websocket origin policy" "./internal/relay/handler" "^TestRealtimeRejectsDisallowedOriginBeforeBillingAndUpstreamDial$"
  run_go_test_no_skips "relay realtime API-token query model authorization" "./internal/relay/handler" "^TestProductionRealtimeAPITokenUsesQueryModelBeforeStreamHandler$"
  run_go_test_no_skips "standalone relay realtime origin config wiring" "./cmd/relay" "^TestBuildStandaloneRelayConfigWiresBatchCommercialLifecycle$"
...
run_workflow_sql_isolation_profile() {
  ...
  workflow_store_pattern="^(TestWorkflowStorePersistsDefinitionsAndExecutions|TestWorkflowStorePersistsVersionHistoryAndExecutionVersion|TestWorkflowSQLStoreReplaysExecutionStateAfterServiceRebuild|TestWorkflowSQLStoreRejectsDuplicateScheduleRunAfterServiceRebuild|TestWorkflowSQLStoreReturnsExistingScheduleRunOnUniqueConflict|TestWorkflowSQLStorePrunesDebugRetentionAfterServiceRebuild|TestWorkflowSQLStoreResolvesPausedFailureAfterServiceRebuild|TestWorkflowSQLStoreRunsDueAutoRetryAfterServiceRebuild)$"
  workflow_http_pattern="^(TestCrossTenantWorkflowScopeDeniesReadWriteAndExecution|TestWorkflowHandlerSignedWebhookRejectsReplayAcrossHandlerRestart|TestWorkflowSemanticTriggerDispatcherRejectsDuplicateConversationEventAcrossDispatcherRestart)$"
...
run_quota_sql_isolation_profile() {
  ...
  quota_store_pattern="^(TestSQLStoreUsageLimitSettingsRoundTrip|TestSQLStoreUserQuotaModeUsesUserScopedBalance|TestSQLStoreBillingSessionsAreOrganizationScoped|TestSQLStoreTopupOrderMutationsRequireOrganizationScope|TestSQLStoreResolveUsageLimitFallsBackToActiveSubscriptionRequestCap|TestSQLStoreListPackagesReturnsOnlyActivePublicHybridPlans)$"
  ...
  quota_stripe_lifecycle_pattern="^(TestLifecycleApplyCheckoutSessionCompletedFulfillsTopupOnce|TestLifecycleApplyRefundRecordsRefundAndAdjustsTopup)$"
...
run_core_sql_persistence_profile() {
  ...
  chat_store_pattern="^(TestSQLStoreMessageShareExpiresAndReadsPublicPayload|TestSQLStoreConversationShareReturnsRequestedMessageRange|TestSQLStoreForkConversationCopiesScopedConversationData|TestSQLStoreConversationConfigPersistsPersonaID|TestSQLStoreCreateAndListMessagePreservesAttachments|TestSQLStoreCreateAndListMessagePreservesKnowledgeCitations|TestSQLStoreListPersonasScopesOrganizationAndOrdersByName|TestSQLStoreForkConversationCopiesMessagesThroughBoundary|TestSQLStoreForkConversationCopiesMessageAttachments|TestSQLStoreListConversationsMarksThreadsWithBookmarkedMessages)$"
  channel_store_pattern="^(TestChannelSQLStorePersistsConfigsAndMessageLogs|TestChannelSQLStoreCountsConsecutiveSuccessfulOutboundDeliveries|TestChannelSQLStoreListsAndClaimsDueRetryMessages|TestChannelSQLStoreListsAndClaimsDueRetryMessagesForSpecificChannel|TestChannelSQLStoreForceClaimsFutureRetryMessagesForManualFailover|TestChannelSQLStoreArchivesExpiredMessageLogsWithoutDeletingRetryQueue|TestChannelSQLStoreArchivesExpiredMessageLogsToObjectBeforeDeleting)$"
  relay_semantic_cache_pattern="^(TestSQLSemanticCacheStoreUsesPgvectorForSimilarityLookup|TestSQLSemanticCacheStorePersistsEntriesAndHitCounts)$"
