...
billing_checkout_topup_required=(
  ...
  "TestHostedCheckoutCreatorRejectsSecretBearingBaseURLs|TestHostedCheckoutCreatorRejectsSecretBearingBaseURLs"
...
marketplace_governance_review_required=(
  "TestGovernanceMigrationAllowsRuntimeReviewActions|TestGovernanceMigrationAllowsRuntimeReviewActions"
  "TestGovernanceTakedownPreventsNewInstallsAndPreservesHistory|TestGovernanceTakedownPreventsNewInstallsAndPreservesHistory"
  "TestGovernanceAppealSQLMovesTakedownIntoPendingAppealQueue|TestGovernanceAppealSQLMovesTakedownIntoPendingAppealQueue"
  "TestGovernanceAppealMovesTakedownIntoPendingAppealQueue|TestGovernanceAppealMovesTakedownIntoPendingAppealQueue"
  "TestGovernanceReinstateSQLRequiresPendingAppealDecision|TestGovernanceReinstateSQLRequiresPendingAppealDecision"
  "TestGovernanceReinstateRejectsTakedownWithoutAppeal|TestGovernanceReinstateRejectsTakedownWithoutAppeal"
  "TestGovernanceReinstateAfterPendingAppealRecordEvents|TestGovernanceReinstateAfterPendingAppealRecordEvents"
  "TestGovernanceRejectAppealSQLRequiresPendingAppealDecision|TestGovernanceRejectAppealSQLRequiresPendingAppealDecision"
  "TestGovernanceRejectAppealRejectsTakedownWithoutPendingAppeal|TestGovernanceRejectAppealRejectsTakedownWithoutPendingAppeal"
  "TestGovernanceAssignReviewSQLRecordsReviewerAssignment|TestGovernanceAssignReviewSQLRecordsReviewerAssignment"
  "TestGovernanceAssignReviewRejectsApprovedAgent|TestGovernanceAssignReviewRejectsApprovedAgent"
  "TestGovernanceAssignReviewRejectsClaimByAnotherReviewer|TestGovernanceAssignReviewRejectsClaimByAnotherReviewer"
  "TestGovernanceAssignReviewAllowsSameReviewerToRefreshClaim|TestGovernanceAssignReviewAllowsSameReviewerToRefreshClaim"
  "TestGovernanceAbuseReportLifecycle|TestGovernanceAbuseReportLifecycle"
  "TestGovernanceListsOpenAbuseReportsForReviewQueue|TestGovernanceListsOpenAbuseReportsForReviewQueue"
  "TestGovernanceAbuseReportNotifiesPublisher|TestGovernanceAbuseReportNotifiesPublisher"
  "TestGovernanceRequestsPublisherChangesForPendingReview|TestGovernanceRequestsPublisherChangesForPendingReview"
  "TestAutomatedReviewAllowsCleanAgentToWaitForManualReview|TestAutomatedReviewAllowsCleanAgentToWaitForManualReview"
  "TestAutomatedReviewRejectsPromptInjectionAndSensitiveAPIFindings|TestAutomatedReviewRejectsPromptInjectionAndSensitiveAPIFindings"
  "TestServiceEnforceReviewSLAsAlertsDueSoonAndOverdueOnce|TestServiceEnforceReviewSLAsAlertsDueSoonAndOverdueOnce"
  "TestServiceEnforceReviewSLAsIncludesAppealPendingQueue|TestServiceEnforceReviewSLAsIncludesAppealPendingQueue"
  "TestAdminHandlerListsReviewsWithMarketplaceReviewSLA|TestAdminHandlerListsReviewsWithMarketplaceReviewSLA"
  "TestAdminHandlerListsAssignedMarketplaceReviewReviewer|TestAdminHandlerListsAssignedMarketplaceReviewReviewer"
  "TestAdminHandlerListsAppealPendingMarketplaceReviews|TestAdminHandlerListsAppealPendingMarketplaceReviews"
  "TestAdminHandlerClaimsMarketplaceReview|TestAdminHandlerClaimsMarketplaceReview"
  "TestAdminHandlerEnforcesMarketplaceReviewSLA|TestAdminHandlerEnforcesMarketplaceReviewSLA"
  "TestAdminReviewSLAEnforceRouteScansPendingReviewsAndAlerts|TestAdminReviewSLAEnforceRouteScansPendingReviewsAndAlerts"
  "TestMarketplaceGovernanceTakedownAppealAndReinstate|TestMarketplaceGovernanceTakedownAppealAndReinstate"
  "TestMarketplaceGovernanceRejectsPendingAppeal|TestMarketplaceGovernanceRejectsPendingAppeal"
  "TestMarketplaceAbuseReportLifecycle|TestMarketplaceAbuseReportLifecycle"
  "TestMarketplaceAdminReviewAuditCarriesAgentOrganization|TestMarketplaceAdminReviewAuditCarriesAgentOrganization"
  "TestMarketplaceAdminReviewNeedsChangesRoute|TestMarketplaceAdminReviewNeedsChangesRoute"
  "TestMarketplacePublishRunsAutomatedReviewGovernance|TestMarketplacePublishRunsAutomatedReviewGovernance"
  "TestAdminMarketplaceListsOpenAbuseReports|TestAdminMarketplaceListsOpenAbuseReports"
  "TestRouteSurfaceAdminMarketplaceReviewMutationsRejectAdminCookieWithoutCSRFWithoutDatabase|TestRouteSurfaceAdminMarketplaceReviewMutationsRejectAdminCookieWithoutCSRFWithoutDatabase"
)
for requirement in "${marketplace_governance_review_required[@]}"; do
  token="${requirement%%|*}"
  test_name="${requirement#*|}"
  require_profile_token "$marketplace_governance_review_body" "marketplace-governance-review" "$token" "$test_name"
done
...
marketplace_settlement_required=(
  ...
  "TestSettlementPayoutRequiresConfiguredProvider|TestSettlementPayoutRequiresConfiguredProvider"
  "TestSettlementCreateDuePayoutsRequiresConfiguredProvider|TestSettlementCreateDuePayoutsRequiresConfiguredProvider"
...
relay_runtime_channel_isolation_required=(
  ...
  "TestRelayStoreRegisterBatchPollingPersistsDurableTask|TestRelayStoreRegisterBatchPollingPersistsDurableTask"
  "TestBatchUsageFinalizerRecordsFailureUsageAuditBeforeRefund|TestBatchUsageFinalizerRecordsFailureUsageAuditBeforeRefund"
  "TestBatchUsageFinalizerSettlesDurableQuotaContext|TestBatchUsageFinalizerSettlesDurableQuotaContext"
  "TestBatchPollingWorkerRefundsTerminalFailureBeforeDeadLetter|TestBatchPollingWorkerRefundsTerminalFailureBeforeDeadLetter"
  "TestNewRelayProductionBatchCommercialLifecycleRequiresPollingRegistrar|TestNewRelayProductionBatchCommercialLifecycleRequiresPollingRegistrar"
  "TestNewRelayProductionRealtimeCommercialLifecycleRequiresRealtimePricing|TestNewRelayProductionRealtimeCommercialLifecycleRequiresRealtimePricing"
  "TestNewRelayProductionRealtimeCommercialLifecycleAcceptsActiveRealtimePricing|TestNewRelayProductionRealtimeCommercialLifecycleAcceptsActiveRealtimePricing"
  "TestRouterRouteWithBillingFinalizesStreamingAbortUsageAndRequestLogScope|TestRouterRouteWithBillingFinalizesStreamingAbortUsageAndRequestLogScope"
  "TestRealtimeRejectsDisallowedOriginBeforeBillingAndUpstreamDial|TestRealtimeRejectsDisallowedOriginBeforeBillingAndUpstreamDial"
  "TestProductionRealtimeAPITokenUsesQueryModelBeforeStreamHandler|TestProductionRealtimeAPITokenUsesQueryModelBeforeStreamHandler"
  "TestBuildStandaloneRelayConfigWiresBatchCommercialLifecycle|TestBuildStandaloneRelayConfigWiresBatchCommercialLifecycle"
...
workflow_sql_isolation_required=(
  ...
  "TestWorkflowSQLStoreRejectsDuplicateScheduleRunAfterServiceRebuild|TestWorkflowSQLStoreRejectsDuplicateScheduleRunAfterServiceRebuild"
  "TestWorkflowSQLStoreReturnsExistingScheduleRunOnUniqueConflict|TestWorkflowSQLStoreReturnsExistingScheduleRunOnUniqueConflict"
  "TestWorkflowSQLStorePrunesDebugRetentionAfterServiceRebuild|TestWorkflowSQLStorePrunesDebugRetentionAfterServiceRebuild"
  "TestWorkflowSQLStoreResolvesPausedFailureAfterServiceRebuild|TestWorkflowSQLStoreResolvesPausedFailureAfterServiceRebuild"
  "TestWorkflowSQLStoreRunsDueAutoRetryAfterServiceRebuild|TestWorkflowSQLStoreRunsDueAutoRetryAfterServiceRebuild"
  "TestCrossTenantWorkflowScopeDeniesReadWriteAndExecution|TestCrossTenantWorkflowScopeDeniesReadWriteAndExecution"
  "TestWorkflowHandlerSignedWebhookRejectsReplayAcrossHandlerRestart|TestWorkflowHandlerSignedWebhookRejectsReplayAcrossHandlerRestart"
  "TestWorkflowSemanticTriggerDispatcherRejectsDuplicateConversationEventAcrossDispatcherRestart|TestWorkflowSemanticTriggerDispatcherRejectsDuplicateConversationEventAcrossDispatcherRestart"
)
