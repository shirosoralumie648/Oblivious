...
const reviewAgent = {
  ...
  ownerName: 'publisherreviewmobileoperatorwithoutbreaks20260624',
  status: 'pending_review',
  visibility: 'public',
  pricingType: 'one_time',
  pricingAmount: 29,
  categoryID: 'cat_productivity',
  categoryName: 'providerresearchclustergovernancecategorywithoutbreaks20260624',
  tags: ['review', 'release'],
  ratingAvg: 4.7,
  rating: 4.7,
  ratingCount: 11,
...
const abuseReport = {
  ...
  details:
    'The listing contains prompt-injection instructions. abusereportevidencemobilewithoutbreaks20260624 requires governance containment.',
  status: 'open',
  createdAt: now,
  updatedAt: now,
};
