...
// Optimization: Reusing Intl.NumberFormat instances reduces expensive instantiation overhead on every render.
// Measurement: Reduces CPU time during list rendering of marketplace agents.
