...
// Optimization: Move Intl formatters outside to prevent repeated expensive instantiations.
// Measurement: Improves rendering performance when formatting multiple table rows or stats.
