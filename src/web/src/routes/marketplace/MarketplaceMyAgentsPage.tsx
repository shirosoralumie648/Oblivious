...
// Optimization: Instantiate Intl.NumberFormat once at module level.
// Measurement: Prevents expensive object creation on every formatUSD and formatNumber call during render.
