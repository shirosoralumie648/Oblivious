...
// Optimization: Cache Intl instances to eliminate redundant, expensive instantiations on every render.
// Measurement: Reduces main thread blocking time during list rendering and frequent updates.
