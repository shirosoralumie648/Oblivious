...
// Optimization: Extract Intl formatters to module scope to prevent recreating them on every render
// Measurement: Eliminates Intl instantiation overhead when rendering settlement tables and stats
