...
// Optimization: Move Intl instances outside render components to prevent expensive repeated instantiations.
// Measurement: Improves DataTable rendering speed by caching formatters across all rows instead of instantiating per-cell.
