...
// ⚡ Bolt: Extracted Intl.NumberFormat to module-level constants to prevent recreating them on every call,
// which improves rendering performance for large lists/tables.
