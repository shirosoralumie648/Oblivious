...
// Optimization: Cache expensive Intl instantiations to prevent recreation on every render
// Measurement: Reduces main thread blocking time during component re-renders
