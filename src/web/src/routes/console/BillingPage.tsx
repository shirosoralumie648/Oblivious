...
// ⚡ Bolt: Cache Intl.NumberFormat and Intl.DateTimeFormat instances since instantiation is expensive.
// Expected impact: Reduces render time for BillingPage by reusing these formatters instead of creating new ones on each call.
