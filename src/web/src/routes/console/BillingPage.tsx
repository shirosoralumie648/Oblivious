...
// Re-using Intl.NumberFormat and Intl.DateTimeFormat instances prevents expensive re-instantiation
// overhead during render cycles, improving performance when rendering multiple integers or dates.
