...
// Optimization: Instantiate Intl.NumberFormat and Intl.DateTimeFormat once at module level.
// Measurement: Prevents expensive object creation on every integer and date formatting call during render.
