...
// Optimization: Cache Intl instances outside the render loop as their instantiation is computationally expensive.
// Measurement: Avoids creating a new Intl formatter on every function call, reducing GC overhead and speeding up renders.
