...
// Optimization: Reusing Intl formatters is significantly faster than recreating them on every format call.
// Measurement: Reduces the overhead of formatting operations in lists and summaries.
const integerFormatter = new Intl.NumberFormat('en-US', { maximumFractionDigits: 0 });

// Optimization: Reusing Intl.DateTimeFormat instance avoids expensive recreation on every row render.
// Measurement: Reduces CPU overhead when rendering invoice lists.
