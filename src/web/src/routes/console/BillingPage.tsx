...
// Optimization: Move Intl formatters outside to avoid recreation overhead per function call.
// Measurement: Reduces CPU time when rendering multiple integers and dates on the billing page.
