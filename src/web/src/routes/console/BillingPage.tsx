...
// Optimization: Reuse Intl.NumberFormat and Intl.DateTimeFormat to avoid expensive instantiation overhead on every render
// Measurement: Reduces CPU time and memory allocation during string formatting
