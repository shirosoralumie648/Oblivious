...
// ⚡ Bolt: Extracted Intl.NumberFormat and Intl.DateTimeFormat to module-level constants to prevent
// recreating them on every render or function call, which reduces formatting overhead.
