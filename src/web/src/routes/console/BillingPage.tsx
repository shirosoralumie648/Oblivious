...
// Optimization: Move Intl APIs instantiation to module level to prevent unnecessary recreation on each render
// Measurement: Reduces instantiation overhead of Intl.NumberFormat and Intl.DateTimeFormat on BillingPage renders
