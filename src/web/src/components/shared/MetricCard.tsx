...
// Optimization: Move Intl.NumberFormat instantiation to module level to prevent unnecessary recreation on each render
// Measurement: Reduces instantiation overhead of Intl.NumberFormat on every MetricCard render
