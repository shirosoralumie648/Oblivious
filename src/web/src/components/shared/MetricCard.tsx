...
// Optimization: Reusing Intl.NumberFormat instance is significantly faster than recreating it on every function call.
// Measurement: Reduces the overhead of formatting operations during component re-renders.
