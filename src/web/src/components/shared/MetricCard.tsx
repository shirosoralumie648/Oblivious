...
// Optimization: Reusing Intl.NumberFormat instance reduces expensive instantiation overhead on every render.
// Measurement: Reduces CPU time during list/grid rendering of multiple metric cards.
