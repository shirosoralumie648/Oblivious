...
// Optimization: Cache Intl.NumberFormat instance to avoid expensive instantiation on every render.
// Measurement: Reduces CPU overhead during component renders by avoiding redundant Intl object creation.
