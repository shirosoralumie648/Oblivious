...
// Optimization: Declare Intl.NumberFormat instances as module-level constants to prevent expensive instantiation on every render.
// Measurement: Reduces CPU overhead during component renders, potentially saving 1-2ms per format call.
