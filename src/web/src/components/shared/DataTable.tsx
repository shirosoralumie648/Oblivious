...
export function DataTable<T>({
  ...
  // Optimization: Memoize selectable rows to prevent iterating over the entire data array on every render (e.g. when checking a checkbox).
  // Measurement: Reduces O(N) iteration on every selection change in large datatables.
