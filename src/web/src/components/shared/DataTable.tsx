...
export function DataTable<T>({
  ...
  // Optimization: Memoize selectableRows to prevent recalculating row IDs on every re-render, especially for large tables
  // Measurement: Reduces CPU cycles during re-renders by caching the result of the map and filter operations
